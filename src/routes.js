...
// Add 
import GlobalLegalPage from "./components/pages/global-legal";
import ChallengesListPage from "./components/pages/hk-challenges-list";
import ParticipantsListPage from "./components/pages/hk-participants-list";
...
const Routes = () => (
  <div className="layout">
    <Switch>
      ...
      <Route
        path="componentaaa-samples"
        component={RequireAuth(ComponentSamplesPage)}
      />
      {/* Add */}
      <Route path="/Global-Legal" component={GlobalLegalPage}/>
      <Route path="/Challenges-list" component={ChallengesListPage}/>
      <Route path="/Participants-list" component={ParticipantsListPage}/>
